...
class RS485Reader(readers.Reader):
    ...
    def get_command_read_sector0(self):
        ...
        command_read_sector0.extend(key_type_a_list)
        check_byte = self.calculate_check_byte(command_read_sector0)
        command_read_sector0.append(check_byte)
    ...
    def get_command_read_default_sector0(self):
        ...
        command_read_default_sector0.extend(key_type_a_list)
        check_byte = self.calculate_check_byte(command_read_default_sector0)
        command_read_default_sector0.append(check_byte)
